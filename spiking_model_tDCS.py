...
#exttaskinput1_off=4750*ms
#exttaskinput1E=PoissonGroup(800,rates=lambda t: (t>exttaskinput1_on)*(t<exttaskinput1_off)*200*Hz)

#taskinput1_coE=IdentityConnection(exttaskinput1E,Pev,'gea',weight=0.0955)

#exttaskinput2_on=9500*ms
#exttaskinput2_off=9750*ms
#exttaskinput2E=PoissonGroup(800,rates=lambda t: (t>exttaskinput2_on)*(t<exttaskinput2_off)*200*Hz)

#taskinput2_coE=IdentityConnection(exttaskinput2E,Pev,'gea',weight=0.0955)

#exttaskinput3_on=14500*ms
#exttaskinput3_off=14750*ms
#exttaskinput3E=PoissonGroup(800,rates=lambda t: (t>exttaskinput3_on)*(t<exttaskinput3_off)*200*Hz)
...
#exttaskinput4_off=6025*ms
#exttaskinput4E=PoissonGroup(800,rates=lambda t: (t>exttaskinput4_on)*(t<exttaskinput4_off)*200*Hz)

#taskinput4_coE=IdentityConnection(exttaskinput4E,Ped,'gea',weight=0.0955)

#exttaskinput5_on=6500*ms
#exttaskinput5_off=6525*ms
#exttaskinput5E=PoissonGroup(800,rates=lambda t: (t>exttaskinput5_on)*(t<exttaskinput5_off)*200*Hz)

#taskinput5_coE=IdentityConnection(exttaskinput5E,Ped,'gea',weight=0.0955)

#exttaskinput6_on=7000*ms
#exttaskinput6_off=7025*ms
#exttaskinput6E=PoissonGroup(800,rates=lambda t: (t>exttaskinput6_on)*(t<exttaskinput6_off)*200*Hz)
...
#Membrane_potential_monitor=StateMonitor(Pev,'V',record=[3,5,9])
