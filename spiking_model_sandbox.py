...
exttaskinput2_on=5000*ms
exttaskinput2_off=5025*ms
...
exttaskinput3_on=5500*ms
exttaskinput3_off=5525*ms
...
#f = open('E_vACC_spikes.txt','w')
#f.write(Mev.t[:])


#f2 = open('I_vACC_spikes.txt','w')
#f.write(Miv.t[:])
...
plot(Mv.times/ms,Mv.smooth_rate(width = 0.1*ms)/Hz)
title('vACC')
